...
layui.use(['table','form'], function() {
	...
	table.render({
		...
		,cols: [[
		    ...
		    ,{field:'id', align:'center', width:'6%', title: 'ID', sort: true}
	...
	var fn_ajax_submit_menu_form = function(data, index) {
		...
		ajax('/oper/menu','POST',success,JSON.stringify(data));
	};
	...
	var fn_get_edit_menu_data = function() {
		...
		var url = '/oper/menu/one?id=' + menu_id;
		ajax(url, 'GET', success, null, false);
		return menu;
	};
